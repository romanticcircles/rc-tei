...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0" xmlns:xhtml="http://www.w3.org/1999/xhtml"
		...
		<TEI xmlns="http://www.tei-c.org/ns/1.0">
			...
			<text>
				<body>
					...
					<div xmlns="http://www.tei-c.org/ns/1.0" type="appEtAliaA">
						<list xmlns="http://www.tei-c.org/ns/1.0">
							<xsl:call-template name="tocEtAlia"/>
						</list>
					</div>
					<div xmlns="http://www.tei-c.org/ns/1.0" type="appEtAliaB">
						<list xmlns="http://www.tei-c.org/ns/1.0">
	...
	<xsl:template match="xhtml:body/xhtml:table/xhtml:tr[3]/xhtml:td/xhtml:table"/>
	<xsl:template match="xhtml:body/xhtml:table/xhtml:tr[3]/xhtml:td/xhtml:hr"/>
	<xsl:template match="xhtml:body/xhtml:table/xhtml:tr[3]/xhtml:td/xhtml:p"/>

	<xsl:template match="xhtml:body/xhtml:table/xhtml:tr[3]/xhtml:td/xhtml:div[@class='appendix']">
		<xsl:for-each select=".">
