...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0" xmlns:xhtml="http://www.w3.org/1999/xhtml"
		...
		<TEI xmlns="http://www.tei-c.org/ns/1.0">
			<teiHeader>
				<fileDesc>
					...
					<publicationStmt>
						<idno type="edition">frank27.acknowl</idno>
					...
					<sourceDesc>
						<biblStruct>
							<analytic>
								<title level="a">
									<xsl:text>EDITORIAL NOTES : ACKNOWLEDGEMENTS</xsl:text>
								</title>
								<author>
			...
			<text>
				<body>
					<div xmlns="http://www.tei-c.org/ns/1.0">
						<head>EDITORIAL NOTES : ACKNOWLEDGEMENTS</head>
	...
	<xsl:template match="xhtml:body//*/xhtml:div[@class='ednotes']/xhtml:h5"/>
	...
	<xsl:template match="xhtml:div[@class='ednotes']/xhtml:table">
		<table xmlns="http://www.tei-c.org/ns/1.0">
			<xsl:apply-templates/>
		</table>
	</xsl:template>

	<xsl:template match="xhtml:td/xhtml:div[@class='ednotes']/xhtml:table/xhtml:tr">
		<row xmlns="http://www.tei-c.org/ns/1.0">
			<xsl:apply-templates/>
		</row>
	</xsl:template>

	<xsl:template match="xhtml:div[@class='ednotes']/xhtml:table/xhtml:tr/xhtml:td">
	...
	<xsl:template match="xhtml:div[@class='ednotes']">
		<item xmlns="http://www.tei-c.org/ns/1.0">
			<xsl:apply-templates/>
		</item>
	</xsl:template>
