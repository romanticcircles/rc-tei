...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0" xmlns:xhtml="http://www.w3.org/1999/xhtml"
		...
		<TEI xmlns="http://www.tei-c.org/ns/1.0">
			<teiHeader>
				<fileDesc>
					...
					<publicationStmt>
						<idno type="edition">
							<xsl:value-of select="'frank27.pop'"/>
						</idno>
					...
					<sourceDesc>
						<biblStruct>
							<analytic>
								<title level="a">
									<xsl:text>STUDY AIDS : IN POPULAR CULTURE</xsl:text>
								</title>
								<author>
			...
			<text>
				<body>
					...
					<div xmlns="http://www.tei-c.org/ns/1.0" type="appPopA">
						<list xmlns="http://www.tei-c.org/ns/1.0">
							<xsl:call-template name="tocPop"/>
						</list>
					</div>
					<div xmlns="http://www.tei-c.org/ns/1.0" type="appPopB">
						<list xmlns="http://www.tei-c.org/ns/1.0">
	...
	<xsl:template match="xhtml:body/xhtml:table/xhtml:tr[2]/xhtml:td/xhtml:a"/>

	<xsl:template match="xhtml:body/xhtml:table/xhtml:tr[2]/xhtml:td/xhtml:div">
		<xsl:apply-templates select="xhtml:p | xhtml:blockquote | xhtml:h2 | xhtml:h3 | xhtml:h4 | xhtml:ul | xhtml:ol | xhtml:li | xhtml:br"/>
	</xsl:template>

	<xsl:template match="xhtml:body/xhtml:table/xhtml:tr[2]/xhtml:td/xhtml:div/xhtml:h2">
		<term xmlns="http://www.tei-c.org/ns/1.0" rend="bold">
			<xsl:apply-templates/>
		</term>
	</xsl:template>

	<xsl:template match="xhtml:body//*/xhtml:h3 | xhtml:body//*/xhtml:h4">
		<xsl:for-each select=".">
