...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0" xmlns:xhtml="http://www.w3.org/1999/xhtml"
		...
		<TEI xmlns="http://www.tei-c.org/ns/1.0">
			<teiHeader>
				<fileDesc>
					...
					<publicationStmt>
						<idno type="edition">frank27.summary</idno>
					...
					<sourceDesc>
						<biblStruct>
							<analytic>
								<title level="a">
									<xsl:text>STUDY AIDS : PLOT SUMMARY</xsl:text>
								</title>
								<author>
			...
			<text>
				<body>
					<div xmlns="http://www.tei-c.org/ns/1.0">
						<head>STUDY AIDS : PLOT SUMMARY</head>
							<xsl:apply-templates/>
					</div>
				</body>
			</text>
	...
	<xsl:template match="xhtml:h2 | xhtml:h3 | xhtml:h4">
