...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0" xmlns:xhtml="http://www.w3.org/1999/xhtml"
		...
		<TEI xmlns="http://www.tei-c.org/ns/1.0">
			<teiHeader>
				<fileDesc>
					...
					<publicationStmt>
						<idno type="edition">frank27.MShelley</idno>
					...
					<sourceDesc>
						<biblStruct>
							<analytic>
								<title level="a">
									<xsl:text>STUDY AIDS : ABOUT THE AUTHOR</xsl:text>
								</title>
								<author>
			...
			<text>
				<body>
					<head>STUDY AIDS : ABOUT THE AUTHOR</head>
					<div xmlns="http://www.tei-c.org/ns/1.0" type="appMShelleyA">
						<list xmlns="http://www.tei-c.org/ns/1.0">
							<xsl:call-template name="tocMShelley"/>
						</list>
					</div>
					<div xmlns="http://www.tei-c.org/ns/1.0" type="appMShelleyB">
						<list xmlns="http://www.tei-c.org/ns/1.0">
	...
	<xsl:template match="xhtml:h3 | xhtml:h4">
	...
	<xsl:template match="xhtml:a">
		<ref xmlns="http://www.tei-c.org/ns/1.0" rend="emph">
	...
	<xsl:template match="xhtml:body//*/xhtml:div[@class='appendix']/xhtml:h5"/>
	<xsl:template match="xhtml:hr"/>

<xsl:template match="xhtml:p">
	<xsl:choose>
		<xsl:when test="@class='desc'"/>
	...
	<xsl:template match="xhtml:div[@class='appendix']/xhtml:table">
		<table  xmlns="http://www.tei-c.org/ns/1.0">
			<xsl:apply-templates/>
		</table>
	</xsl:template>
	
	<xsl:template match="xhtml:td/xhtml:div[@class='appendix']/xhtml:table/xhtml:tr">
				<row  xmlns="http://www.tei-c.org/ns/1.0">
					<xsl:apply-templates/>
				</row>
	</xsl:template>
	
	<xsl:template match="xhtml:div[@class='appendix']/xhtml:table/xhtml:tr/xhtml:td">
	...
	<xsl:template match="xhtml:div[@class='appendix']">
			<item xmlns="http://www.tei-c.org/ns/1.0">
				<xsl:apply-templates/>
			</item>
	</xsl:template>

	<xsl:template name="tocMShelley">
